<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
        if(isset($_POST['email']) && isset($_POST['user']) && isset($_POST['pwd']) && isset($_POST['vPwd']))
        {
            ...
            elseif(registrarUsuari($userPOST,$emailPOST,$fNamePOST,$lNamePOST,$passPOSTHashed))
            {
                setcookie("success","<p class='alert alert-success'>You have successfully registered!</p>",time()+3600);
